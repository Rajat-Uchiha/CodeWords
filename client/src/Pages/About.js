...
const About = () => {
  return (
    <>
      <Navbar />
      <section className="bg-black text-white min-h-screen py-4 md:py-10 ">
        <div className="font-Kanit space-y-4 text-white py-6 ">
          <h1 className="font-bold text-start mx-10 md:mx-0 md:text-center">
            <span className="text-transparent font-Kanit text-3xl md:text-6xl font-semibold bg-clip-text bg-gradient-to-r from-blue-600 to-pink-700">
              CodeWords - Your Platform for Coding Narratives
            </span>
          </h1>
          <p className=" px-10 md:px-40 text-md md:text-2xl">
            Welcome to CodeWords, the premier destination for passionate coders,
            developers, and tech enthusiasts to share their insights,
            experiences, and journeys in the vast world of programming. Our
            blogging web app is designed to be your digital canvas, where you
            can craft and share stories, tutorials, and reflections on all
            things coding.
          </p>
        </div>
        <div className="font-Kanit space-y-4 text-white py-6 ">
          ...
          <p className=" px-10 md:px-40 text-md md:text-2xl">
            ...
            by providing a platform where individuals can articulate their
            coding adventures, share technical expertise, and foster a sense of
        ...
        <div className="font-Kanit space-y-4 text-white py-6 ">
          ...
          <ul className="px-10 md:px-40 md:text-2xl space-y-4 md:space-y-0 list-disc">
            <li className="space-y-2">
              <h3 className="underline underline-offset-8 text-lg md:text-2xl">
                Diverse Content
              </h3>
        ...
        <div className="font-Kanit space-y-4 text-white py-6 ">
          ...
          <ul className="px-10 md:px-40 md:text-2xl space-y-4 md:space-y-0 list-disc">
            ...
            <li className="space-y-2">
              <h3 className="underline underline-offset-8 text-lg md:text-2xll">
                Company Chronicles
              </h3>
              <p className="text-md: md:text-2xl">
            ...
            <li className="space-y-2">
              ...
              <p className="text-md: md:text-2xl">
                ...
                Your journey may be the beacon that guides someone on their
                coding path.
              </p>
            </li>
            <li className="space-y-2">
        ...
        <div className="font-Kanit space-y-4 text-white py-6  ">
          ...
          <p className=" px-10 md:px-40 text-md md:text-2xl">
            ...
            between, CodeWords is your canvas to paint the vibrant picture of
            your coding experiences. Join our community, unleash your
            creativity, and be part of a platform that celebrates the diverse
            narratives within the coding world. Start your coding chronicle
            today! Together, let's weave the tapestry of the coding community at
            CodeWords.
          </p>
        </div>
        <div className=" w-full md:w-1/6 mx-10 md:mx-auto flex">
          <Link
            to="/signup"
            className="my-2 text-sm px-12 font-bold font-Kanit hover:scale-110 transition-all text-white bg-yellow-500 py-2 "
          >
            JOIN NOW
          </Link>
        </div>
